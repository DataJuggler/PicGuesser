        ...
        #region Static Methods
            ...
            internal static SqlParameter[] CreateInsertParameters(Image image)
            {
                ...
                if(image != null)
                {
                    ...
                    param = new SqlParameter("@Assigned", image.Assigned);
                    ...
                    // Create [TotalPixels] parameter
                    param = new SqlParameter("@TotalPixels", image.TotalPixels);
            ...
            internal static SqlParameter[] CreateUpdateParameters(Image image)
            {
                ...
                if(image != null)
                {
                    ...
                    // Create parameter for [TotalPixels]
                    param = new SqlParameter("@TotalPixels", image.TotalPixels);
